  ...
  return (
    <div className="py-5 bg-white">
      <div className="px-8 pb-2 ">
        {/* Header */}
        <h2 className="text-3xl text-center text-prime-brown clash-display">
          Top Podcasters of the Week
        </h2>

        {/* Cards Section */}
        <div className="my-10 w-full h-82.5 whitespace-nowrap centered-row gap-4 overflow-x-scroll ">
          {/* Card */}
