  ...
  return (
    ...
    >
      ...
      <div className="col gap-3 ">
        <h2 className="text-4xl  clash-display lg:text-5xl">{name}</h2>
        <span className="text-prime-brown bg-zinc-100 p-2 px-4 rounded-full text-sm w-fit lg:mt-2 lg:text-xl z-10">
          {view}
        </span>
      </div>
      ...
      <img
        src={decor}
        alt="decorative"
        className={`w-[50%] md:w-[70%] absolute z-0 ${decorPosition}`}
      />
    </div>
  );
};
